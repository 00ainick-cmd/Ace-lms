    ...
    async initDashboard() {
        ...
        try {
            ...
            if (finalEvents.length === 0) {
                // No events yet - show fresh start state
                const bubble = document.querySelector('.speech-bubble p, .ace-coaching p, #ace-recommendation');
                if (bubble) bubble.textContent = 'Welcome to ACE! Start a practice drill or flashcard session to unlock your stats and study recommendations.';
                return;
            }
