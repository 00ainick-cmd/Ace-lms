// Reuse AceAuth's client if available
if (window.AceAuth && typeof AceAuth.getDB === 'function') {
  const _existing = AceAuth.getDB();
  if (_existing) { window._supabaseClient = _existing; }
}
